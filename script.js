...
const hitSound=new Audio('/home/sheethal/Downloads/blackjack_assets/sounds/swish.m4a');
const winSound=new Audio('/home/sheethal/Downloads/blackjack_assets/sounds/cash.mp3');
const lostSound=new Audio('/home/sheethal/Downloads/blackjack_assets/sounds/aww.mp3');
...
function showCard(card,activePlayer) {
  if(activePlayer['score']<=21){
    ...
    cardImage.src=`/home/sheethal/Downloads/blackjack_assets/images/${card}.png`;
